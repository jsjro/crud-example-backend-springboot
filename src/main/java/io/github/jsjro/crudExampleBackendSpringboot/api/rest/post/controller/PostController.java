package io.github.jsjro.crudExampleBackendSpringboot.api.rest.post.controller;

import io.github.jsjro.crudExampleBackendSpringboot.api.rest.post.model.Post;
import io.github.jsjro.crudExampleBackendSpringboot.api.rest.post.repository.PostRepository;
...
public class PostController {
    ...
    public ResponseEntity<Post> updatePost(@PathVariable("id") long id, @RequestBody Post post) {
        ...
        if (postData.isPresent()) {
            ...
            _post.setCreate_date(post.getCreate_date());
